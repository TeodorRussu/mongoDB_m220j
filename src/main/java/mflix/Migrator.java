...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            System.out.println("imdb is already double");
    ...
    private static UpdateOneModel<Document> transformDates(Document doc, DateFormat dateFormat) {
        ...
        if (lastUpdated.length() == 19){
            lastUpdated = lastUpdated + ".000000000";
        }
    ...
    public static void main(String[] args) {
        ...
        // DONE - TODO> Ticket: Migration - set the cluster connection string.
        String mongoUri = "mongodb+srv://m220student:m220password@mflix-dpbje.mongodb.net/test?retryWrites=true&w=majority";
        ...
        FindIterable<Document> documents = movies.find(dateStringFilter).limit(10000);
        ...
        FindIterable<Document> documents1 = movies.find(ratingStringFilter);
